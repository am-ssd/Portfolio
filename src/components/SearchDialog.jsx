...
const searchData = [
  {
    ...
    path: '/',
    keywords: ['home', 'cv', 'resume', 'start', 'welcome', 'portfolio', 'yuki', 'Yuki Mori', 'niladri1', 'software developer', 'full stack developer', 'mern stack', 'web developer'],
  },
  {
    title: 'About',
    description: 'Learn more about me and my background',
    path: '/about',
    keywords: ['about', 'background', 'education', 'bio', 'profile', 'cv', 'resume', 'yuki', 'chatterjee', 'full stack developer', 'software engineer', 'web developer'],
  },
  {
    title: 'Education',
