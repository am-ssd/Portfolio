...
const Education = () => {
  const educationData = [
    {
      school: 'Łódź University of Technology',
      ...
      image: collegeImg,
      resultUrl: bTechPdf,
      coursework: ["Full-Stack Development", 'DSA', 'OOPs', 'DBMS', 'AI', 'ML', 'OS', 'Networking'],
      description:
        'During my time at BCET, I have built a strong foundation in computer science, focusing on Full-Stack development, problem-solving, and real-world applications. Engaging in hands-on projects, internships, and coding challenges has helped me enhance my technical and analytical skills.',
    },
    // {
